...
for triggerSpec in \
  "OnNewFile|GetOnNewFileItems|When a file is created (properties only)" \
  "OnUpdatedFile|GetOnUpdatedFileItems|When a file is created or modified (properties only)"
do
