...
create_trigger "OnNewFile" "OnNewFilesV2" "[{name:folderId,value:'$onedriveFolderId'}]"
create_trigger "OnUpdatedFile" "OnUpdatedFilesV2" "[{name:folderId,value:'$onedriveFolderId'}]"
